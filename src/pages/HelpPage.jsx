    ...
    <div>
      ...
      <div className="min-h-screen bg-white pt-20 border-gray-800 relative ">
        <img
          src={wave2}
          alt="Background"
          className="absolute inset-0 w-full h-3/2 object-cover"
        />

        <div className="relative max-w-[2000px] mx-auto px-2 md:px-72 py-8">
          <div className="text-center mb-25 mt-10">
            <h1 className="text-4xl md:text-5xl lg:text-[3rem] font-bold mb-2 text-blue-950">
              Hello, how can we help you?
            </h1>
            <p className="text-gray-600 text-2xl mt-4  mb-16">
              Find Travel guide, FAQ, chat...
            </p>
          </div>
          {/* faq & Travel Guide  */}
          {/* FAQ & Travel Guide Section */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 mt-32">
            <div className="bg-white rounded-xl p-7 flex items-center gap-8 shadow-xl">
              <div className="w-16 h-16 flex items-center justify-center">
                <img src={Question} alt="" className="w-12 h-12" />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-black">FAQ</h3>
            ...
            <div className="bg-white rounded-xl p-7 flex items-center gap-8 shadow-xl">
              <div className="w-16 h-16 flex items-center justify-center">
                <img src={travelGuide} alt="" className="w-12 h-12" />
              </div>
              <div>
          ...
          <div className="space-y-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-xl">
              <button
                ...
                className="w-full p-8 flex items-center justify-between bg-white text-black"
              >
