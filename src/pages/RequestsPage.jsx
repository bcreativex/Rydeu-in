        ...
        <div className="bg-white rounded-lg shadow-sm p-4 md:p-8">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs mt-4 md:mt-10 md:text-sm font-bold text-gray-500 mb-4 md:mb-8">
                Offer Available until{" "}
                <span className="font-medium">10th May, 19:00</span>
              </div>
            </div>
          ...
          <div className="flex justify-center mt-8">
            <button className="bg-pink-500 text-white px-8 py-2 rounded-lg hover:bg-pink-600 transition-colors">
              Submit
            </button>
          </div>
        </div>
